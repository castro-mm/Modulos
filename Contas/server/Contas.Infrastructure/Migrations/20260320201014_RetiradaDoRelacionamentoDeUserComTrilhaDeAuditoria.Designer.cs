...
namespace Contas.Core.Migrations
{
    ...
    [Migration("20260320201014_RetiradaDoRelacionamentoDeUserComTrilhaDeAuditoria")]
    partial class RetiradaDoRelacionamentoDeUserComTrilhaDeAuditoria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contas.Core.Entities.System.Security.ApplicationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Contas.Core.Entities.System.Security.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Contas.Core.Entities.System.Security.ApplicationUserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Contas.Core.Entities.ArquivoDoRegistroDaConta", b =>
                {
                    ...
                    b.HasOne("Contas.Core.Entities.System.Security.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Contas.Core.Entities.System.Security.ApplicationUserRole", b =>
                {
                    b.HasOne("Contas.Core.Entities.System.Security.ApplicationRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Contas.Core.Entities.System.Security.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Contas.Core.Entities.System.Security.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
